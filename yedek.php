...
function login($username, $password) {
    ...
    // Kullanıcı adının @sakarya.edu.tr içerdiğini kontrol et
    if (strpos($username, '@sakarya.edu.tr') === false) {
        return false;
    }
    
    // Kullanıcı adının @gmail.com içermediğini kontrol et
...
<body>
    ...
    if ($_SERVER["REQUEST_METHOD"] == "POST") {
        ...
        } elseif (strpos($_POST["username"], '@gmail.com') !== false) {
            echo "<p style='color:red'>@gmail.com kullanıcıları giremez!</p>";
        } else {
